<?php namespace App\Http\Controllers;
	...
	class AdminTbAnakController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Dosen Id','name'=>'dosen_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'dosen,id'];
			}
			...
			$this->form[] = ['label'=>'Pekerjaan','name'=>'pekerjaan','type'=>'select','validation'=>'required','width'=>'col-sm-10','dataenum'=>'Pelajar;Mahasiswa;PNS;Buruh;Polisi;Pengusaha;Dosen;Guru;Ibu Rumah Tangga;Dan Lain-Lain'];
			$this->form[] = ['label'=>'Keterangan','name'=>'keterangan','type'=>'select','validation'=>'required','width'=>'col-sm-10','dataenum'=>'Hidup;Meninggal;Pensiun;Dan Lain-lain'];
			...
			//$this->form[] = ["label"=>"Tgl Nikah","name"=>"tgl_nikah","type"=>"date","required"=>TRUE,"validation"=>"required|date"];
